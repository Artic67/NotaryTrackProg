export async function main(name) {
  ...
  async function makeMainDiagram() {
    ...
    let dbdata = await db.DBController
      .getData(`SELECT Services.Id as ServiceId, SubCategories.Id as SubcatId, Categories.Id as CatId, ft.Num as Num, Categories.Name as CatName, ft.PriceSum as PriceSum
